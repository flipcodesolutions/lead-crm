...
@section('page_title', 'Edit Profile: ' . $employee->full_name)
    ...
    <div class="col-lg-10">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 px-4 d-flex justify-content-between align-items-center">
                <h5 class="fw-bold m-0"><i class="bi bi-pencil-square text-primary me-2"></i> Update Employee Profile</h5>
                ...
                <form action="{{ route('hr.employees.update', $employee->id) }}" method="POST">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="date_of_birth" class="form-control @error('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth', $employee->date_of_birth?->format('Y-m-d')) }}">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="manager_id" class="form-select @error('manager_id') is-invalid @enderror">
                                ...
                                @foreach($managers as $mgr)
                                    <option value="{{ $mgr->id }}" {{ old('manager_id', $employee->manager_id) == $mgr->id ? 'selected' : '' }}>{{ $mgr->full_name }} ({{ $mgr->designation->name ?? 'Staff' }})</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="joining_date" class="form-control @error('joining_date') is-invalid @enderror" value="{{ old('joining_date', $employee->joining_date?->format('Y-m-d')) }}">
                    ...
                    <div class="d-flex justify-content-between pt-3 border-top">
                        <a href="{{ route('hr.employees.show', $employee->id) }}" class="btn btn-light rounded-pill px-4">Cancel</a>
